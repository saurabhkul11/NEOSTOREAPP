...
class HomeScreen : AppCompatActivity() ,View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this).load(ProfilePicUrl).placeholder(R.drawable.profile_icon).into(mProfile)
        ...
        toggle = object : ActionBarDrawerToggle(this, navDrawer, R.string.open, R.string.close) {
                override fun onDrawerOpened(drawerView: View) {
                    super.onDrawerOpened(drawerView)
                    supportActionBar?.setHomeAsUpIndicator(R.drawable.back_symbol)
                }
